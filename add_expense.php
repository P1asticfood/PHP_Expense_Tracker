    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO expenses (user_id, title, description ,amount, category, date) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("issdss", $uid, $title,$description ,$amount, $category, $date);
        $stmt->execute();
